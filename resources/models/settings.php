...
return [
    'form' => [
        ...
        'rules' => [
            ...
            ['reverb_app_id', 'lang:igniter.broadcast::default.label_reverb_app_id', 'nullable|required_if:provider,pusher,reverb|integer'],
            ['reverb_key', 'lang:igniter.broadcast::default.label_reverb_key', 'nullable|required_if:provider,pusher,reverb|string'],
            ['reverb_secret', 'lang:igniter.broadcast::default.label_reverb_secret', 'nullable|required_if:provider,pusher,reverb|string'],
